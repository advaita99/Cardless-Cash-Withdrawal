...
public class View_acc_number extends Activity {
	ListView l1;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_view_acc_number);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.view_acc_number, menu);
		return true;
	}
...
//			         Toast.makeText(getApplicationContext(), Login.uid, 3).show();
			         ...
			         ListAdapter adapter = new SimpleAdapter(View_acc_number.this, al,
			            R.layout.account, new String[]{ "account_number","balance", "account_number","balance"}, 
